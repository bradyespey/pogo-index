...
$(document).ready(function () {
    ...
    window.specialsTable = initializeDataTable({
        ...
        columns: [
            ...
            { title: 'Name', filterType: 'text' },        // Index 1
            {
                title: 'Type',
                filterType: 'select',
                options: ['Legendary', 'Mythical', 'Ultra Beast', 'Paradox']
            },                                            // Index 2
        ],
        extraFilters: [
    ...
    $('#resetFiltersButton').on('click', function () {
        if (window.specialsTable) {
            // Clear DataTables filters
            window.specialsTable.search('').columns().search('').draw();

            // Reset cloned header inputs and selects
            const clonedHeader = window.specialsTable.table().header();
            ...
            $('#showEntries').val('10');
            window.specialsTable.page.len(10).draw();
        }
    });
    ...
    $('#showEntries').on('change', function () {
        ...
        window.specialsTable.page.len(entries).draw();
    });
});
